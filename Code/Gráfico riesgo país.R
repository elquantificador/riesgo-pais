...
gráfico_riesgo <- ggplot(data, aes(x = Periodo, y= Puntos.base)) +
  ...
  labs(x = '',
       ...
       caption = 'El gráfico muestra la evolución del riesgo país en Ecuador durante el periodo de 2019 a 2023. Los puntos base son la medida que indica 
       el cambio porcentual entre la tasa de interés de los bonos del gobierno de un país (riesgosa) y la tasa de interés libre de riesgo. Un punto base es 0.01%. 
       Muestra el panorama económico para la inversión extranjera La primera zona roja del gráfico está asociada a un aumento en el valor del riesgo debido 
       a la crisis política causada por el paro nacional en octubre del 2019.La segunda zona roja está asociada al inicio de la pandemia COVID-19 a finales de febrero. 
       En el primer cuatrimestre del año 2021 hay una bajada que se debe al posicionamiento del nuevo gobierno con Guillermo Lasso como presidente. A finales 
       de mayo del 2022 existe una subida que está ligada a otro paro nacional provocado por los precios de los combustibles. Por último, la subida a finales 
       de enero del 2023 se debe principalmente a la inestabilidad del gobierno donde se pedía la renuncia del presidente Guillermo Lasso. Posteriormente 
       se puede observar el incremento en la zona gris que se debe a hechos actuales como al anunciamiento de la muerte cruzada que conlleva a la disolución 
